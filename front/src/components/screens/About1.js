  ...
  return (
    <div>
        ...
        <div class="container px-6 py-16 mx-auto">
            <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">Our Team
            </h1>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2 xl:px-[40vh]">
                <div
                    ...
                    <img class="object-cover w-64 h-64 rounded-full ring-4 ring-gray-300"
                        src="https://res.cloudinary.com/dhw1mueq4/image/upload/v1695735438/Screenshot_from_2023-09-26_16-36-58_dbx3yx.png" alt="Team" />

                    <h1
                        class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">
                        Mulubrhan Geberkidan</h1>

                    <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">ALX Software Enginnering Student</p>
    ...
    <section class="text-gray-600 body-font relative bg-gray-100 py-4">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Us</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">If You have a feedback for us or any questions
            ...
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                        <button
                            class="flex mx-auto text-white bg-sky-600 border-0 py-2 px-8 focus:outline-none hover:bg-sky-700 rounded text-lg">Send</button>
                    </div>
